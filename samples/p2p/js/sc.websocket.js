 ...
 * @classDesc Network module for PureRTC P2P chat
 */
function SignalingChannel() {
  ...
  this.sendMessage = function(message, targetId, successCallback,
    ...
    wsServer.emit('purertc-message', data, function(err) {
  ...
  this.connect = function(loginInfo, successCallback, failureCallback) {
    ...
    wsServer.on('purertc-message', function(data) {
      L.Logger.info('Received purertc message.');
      if (self.onMessage)
